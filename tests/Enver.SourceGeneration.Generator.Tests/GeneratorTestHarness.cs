...
using Enver.SourceGeneration.Generator;
    ...
    public static Result Run(string source)
    {
        ...
        var compilation = CSharpCompilation.Create(
            ...
            references: tpa.Split(Path.PathSeparator)
                .Where(p =>
                    Path.GetFileNameWithoutExtension(p) != "Enver.SourceGeneration.Generator"
                )
        ...
        var driver = CSharpGeneratorDriver.Create(new EnverConfigGenerator());
