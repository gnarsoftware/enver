...
public class GeneratorDriverTests
{
    ...
    [Test]
    public void AppliesPrefixAndKeyNamingFromEnvConfig()
    {
        var result = GeneratorTestHarness.RunExpectingSuccess(
            """
            namespace Test;
            ...
            [Enver.Binding.EnvBindable]
            [Enver.Binding.EnvConfig("DB", KeyNaming = Enver.Binding.EnvKeyNamingConvention.UpperSnakeCase)]
    ...
    [Test]
    public void EmitsCompilableBinderWithEnvUriKind()
    {
        var result = GeneratorTestHarness.RunExpectingSuccess(
            """
            namespace Test;
            ...
            {
                [Enver.Binding.EnvUri(System.UriKind.Relative)]
                public System.Uri Endpoint { get; init; }
            }
            """
        );

        // [EnvUri] threads UriKind.Relative into both the byte-path
    ...
    public void EmitsCompilableBinderWithFormatProviderPrecedence()
    {
        var result = GeneratorTestHarness.RunExpectingSuccess(
            ...
            public partial class FpConfig
            {
                ...
                [Enver.Binding.EnvFormatProvider(typeof(System.Globalization.CultureInfo), "CurrentCulture")]
        ...
        // [EnvFormatProvider] overrides it on UsesOverride.
        var src = result.SingleSource().Text;
        using (Assert.EnterMultipleScope())
        {
            Assert.That(
    ...
    public void AcceptsPrivateFormatProviderWithinHost()
    {
        ...
        var result = GeneratorTestHarness.RunExpectingSuccess(
            ...
            [Enver.Binding.EnvBindable]
            [Enver.Binding.EnvFormatProvider(typeof(SelfFp), "s_culture")]
    ...
    public void EmitsBinderForExternalTarget()
    {
        var result = GeneratorTestHarness.RunExpectingSuccess(
            ...
            [Enver.Binding.EnvBindable<DbConfig>]
    ...
    public void EmitsSeparateFilesPerExternalTarget()
    {
        var result = GeneratorTestHarness.RunExpectingSuccess(
            ...
            [Enver.Binding.EnvBindable<DbConfig>]
            [Enver.Binding.EnvBindable<CacheConfig>]
            public partial class AppHost;
            """
        );
    ...
    public void ExternalTargetSilentlySkipsMembersWithHostInaccessibleSetters()
    {
        ...
        // assign it. Without an explicit [EnvKey] opt-in it's dropped quietly.
        var result = GeneratorTestHarness.RunExpectingSuccess(
            """
            namespace Test;
    ...
    public void ReportsEnvr0012WhenPrefixProducesInvalidKey()
    {
        ...
        var result = GeneratorTestHarness.Run(
            ...
            [Enver.Binding.EnvBindable]
            [Enver.Binding.EnvConfig("bad-prefix")]
    ...
    public void ReportsEnvr0008WhenIgnoredMemberAlsoHasKey()
    {
        var result = GeneratorTestHarness.Run(
            ...
            public partial class RedundantKey
            {
                ...
                [Enver.Binding.EnvIgnore]
                [Enver.Binding.EnvKey("UNUSED")]
    ...
    [Test]
    public void ReportsEnvr0003WhenEnvUriOnNonUriMember()
    {
        var result = GeneratorTestHarness.Run(
            """
            namespace Test;
    ...
    public void ReportsEnvr0004WhenFormatProviderMemberInvalid()
    {
        ...
        var result = GeneratorTestHarness.Run(
            ...
            [Enver.Binding.EnvBindable]
            [Enver.Binding.EnvFormatProvider(typeof(string), "Empty")]
    ...
    public void ReportsEnvr0014WhenFormatProviderHasNoEffect()
    {
        ...
        // [EnvFormatProvider] on a Guid member has no effect.
        var result = GeneratorTestHarness.Run(
            """
            namespace Test;
    ...
    {
        // Secret is explicitly opted in with [EnvKey], but its setter is
        // private to DbConfig.
        var result = GeneratorTestHarness.Run(
            """
            namespace Test;
    ...
    public void SubSectionLeafIgnorePrefixDropsWholeChain()
    {
        var result = GeneratorTestHarness.RunExpectingSuccess(
            ...
            {
                [Enver.Binding.EnvKey("DB_HOST")]
                public required string Host { get; init; }

                [Enver.Binding.EnvKey("ABSOLUTE_KEY", IgnorePrefix = true)]
    ...
    [Test]
    public void SubSectionDetectedViaEnvConfigAttribute()
    {
        var result = GeneratorTestHarness.RunExpectingSuccess(
            """
            namespace Test;
    ...
    {
        // The parent uses SnakeCase. The subsection type has no [EnvConfig],
        ...
        var result = GeneratorTestHarness.RunExpectingSuccess(
            ...
            [Enver.Binding.EnvBindable]
            [Enver.Binding.EnvConfig(KeyNaming = Enver.Binding.EnvKeyNamingConvention.SnakeCase)]
            public partial class Config
            {
        ...
        using (Assert.EnterMultipleScope())
        {
            // MaxConnections has no [EnvKey], so the name is transformed.
    ...
    public void SubSectionWithExplicitKeyNamingOverridesInheritance()
    {
        ...
        var result = GeneratorTestHarness.RunExpectingSuccess(
            ...
            [Enver.Binding.EnvConfig(KeyNaming = Enver.Binding.EnvKeyNamingConvention.UpperSnakeCase)]
            public class Sub
            {
                public required int MaxConnections { get; init; }
            }
    ...
    {
        // [EnvKey] on a property with no setter can never be bound.
        var result = GeneratorTestHarness.Run(
            """
            namespace Test;
    ...
    public void SubSectionPropertyNameBecomesPrefix()
    {
        var result = GeneratorTestHarness.RunExpectingSuccess(
            ...
            [Enver.Binding.EnvBindable]
            public partial record Base([property: Enver.Binding.EnvKey] Sub Sub);
            """
        );
    ...
    public void SubSectionKeyIgnorePrefixDropsInheritedOnly()
    {
        var result = GeneratorTestHarness.RunExpectingSuccess(
            ...
            public partial record Base(
                [property: Enver.Binding.EnvKey(IgnorePrefix = true)] Sub Sub
            );
            """
        );
    ...
    [Test]
    public void SubSectionRequiredViaEnvKey()
    {
        var result = GeneratorTestHarness.RunExpectingSuccess(
            """
            namespace Test;
    ...
    public void EmitsPopulateMethodsWhenGeneratePopulateIsTrue()
    {
        var result = GeneratorTestHarness.RunExpectingSuccess(
            ...
            [Enver.Binding.EnvBindable]
            [Enver.Binding.EnvConfig(GeneratePopulate = true)]
            public partial class Config
            {
