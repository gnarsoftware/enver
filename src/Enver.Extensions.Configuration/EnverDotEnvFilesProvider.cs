...
internal sealed class EnverDotEnvFilesProvider : ConfigurationProvider, IDisposable
{
    private readonly EnverDotEnvFilesSource _source;
    private readonly IDisposable? _changeTokenRegistration;

    public EnverDotEnvFilesProvider(EnverDotEnvFilesSource source)
    {
