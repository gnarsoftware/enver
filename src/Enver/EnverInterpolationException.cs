...
public class EnverInterpolationException : EnverException
{
    ...
    /// exception.
    /// </summary>
    public EnverInterpolationException(string message, Exception inner)
        : base(message, inner)
    {
        InterpolationKey = string.Empty;
    }
    ...
    /// resolution failed.
    /// </summary>
    public EnverInterpolationException(string variable, string interpolationKey, string message)
    ...
    internal EnverInterpolationException(string variable, string message)
        : base(variable, message)
    {
        InterpolationKey = string.Empty;
    }

    internal EnverInterpolationException(string variable, string message, Exception inner)
        : base(variable, message, inner)
    {
        InterpolationKey = string.Empty;
    }
    ...
    /// Distinct from <see cref="EnverException.Variable"/>, which names the
    /// variable being materialized when the resolution failed.
    /// </summary>
    public string InterpolationKey { get; init; }

    /// <summary>
    /// Throws <see cref="EnverInterpolationException"/> indicating that the
    ...
    {
        throw new EnverInterpolationException(
            variable,
            interpolationKey,
